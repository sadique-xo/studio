  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          size="icon"
          className="rounded-full w-16 h-16 bg-[#25D366] hover:bg-[#128C7E] text-white shadow-lg"
          onClick={toggleOpen}
        >
          ...
          <Card className="w-80 shadow-2xl">
            <CardHeader className="flex flex-row items-center justify-between bg-primary text-primary-foreground p-4 rounded-t-lg">
                <div className="flex items-center gap-3">
                    <Image src="/Profile.PNG" alt={siteSettings.title} width={40} height={40} className="rounded-full" />
                    <div>
            ...
            <CardContent className="p-4 bg-card h-80 overflow-y-auto">
                <div className="bg-secondary text-secondary-foreground p-3 rounded-lg max-w-xs self-start">
            ...
            <CardFooter className="p-4 border-t bg-card rounded-b-lg">
                <div className="flex w-full items-center gap-2">
                    ...
                    />
                    <Button size="icon" onClick={handleSend} disabled={!message} className="bg-[#25D366] hover:bg-[#128C7E]">
