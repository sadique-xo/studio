...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 w-full">
        <header className="container mx-auto flex h-16 items-center justify-between rounded-full border border-border/20 bg-background/30 px-6 backdrop-blur-lg shadow-sm">
